...
QT_MOC_LITERAL(1, 7, 8), // "showInfo"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 4), // "info"
QT_MOC_LITERAL(4, 22, 8) // "workDone"

    },
    "DoWork\0showInfo\0\0info\0workDone"
};
...
void DoWork::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->showInfo((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (DoWork::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DoWork::showInfo)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DoWork::workDone)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject DoWork::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DoWork.data,
      qt_meta_data_DoWork,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void DoWork::showInfo(QString _t1)
{
